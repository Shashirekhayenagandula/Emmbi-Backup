...
import fetchLookupData from '@salesforce/apex/NewOverrideOrderController.fetchLookupData';
...
export default class parentLookup extends LightningElement {
    ...
    @wire(fetchLookupData, { searchKey: '$searchKey' , sObjectApiName : '$sObjectApiName' , productGroupId:'$defaultRecordId'})
        searchResult(value) {
