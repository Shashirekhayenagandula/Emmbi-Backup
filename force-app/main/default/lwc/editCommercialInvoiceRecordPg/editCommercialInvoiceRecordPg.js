...
//     this.showToast('Error', 'error', 'Please select Commercial Invoice'); return;
// } 
if(this.filesData.length > 1 || this.filesDataa.length > 1){
...
//    this.template.querySelector('lightning-record-edit-form').submit(fields);
  ...
  ///////////////
    ...
    const even = new ShowToastEvent({
        title: 'Success!',
        message: 'Commercial Invoice was saved successfully!',
        variant: 'success'
    });
...
closeQuickAction() {
    ...
    if(this.parentId != ''){
        console.log('record page from order222');
        this[NavigationMixin.Navigate]({
            type: 'standard__objectPage',
            attributes: {
              objectApiName: 'Retail_Upload_Commercial_Invoice__c',
